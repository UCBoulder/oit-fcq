...
setwd(paste0('G:\\My Drive\\Course_Audit'))
...
# backup (has date, goes to sharepoint)
saveWorkbook(audit_all, paste0('C:\\Users\\', userid, '\\UCB-O365\\AIM Measurement - FCQ\\CourseAudit_bak\\', term_cd, '\\audit', term_cd, '_', format(appenddt, format = '%m%d%y'), '.xlsx'), overwrite = TRUE)
